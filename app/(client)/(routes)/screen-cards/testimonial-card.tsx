    ...
    <>
      <ClientOnly>
        {isLoading ? (
          ...
          <figure className="md:flex bg-slate-100 hover:bg-slate-200 justify-center transition rounded-sm hover:shadow-2xl p-8 md:p-0 hover:-translate-y-2 duration-300 shadow-md">
